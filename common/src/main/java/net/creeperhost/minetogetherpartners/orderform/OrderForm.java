...
public class OrderForm {
    ...
    public static void onScreenPostInit(Screen screen) {
        if (screen instanceof TitleScreen && Config.instance().replaceRealms) {
            ...
            if (realms != null) {
                screen.addRenderableWidget(Button.builder(Component.translatable("minetogether:button.getserver"), p -> Minecraft.getInstance().gui.setScreen(new OrderGui.Screen(null)))
