...
public class MineTogetherFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        if (Platform.getEnv() == EnvType.CLIENT) {
            clientInit();
            ResourceManagerHelper.get(PackType.CLIENT_RESOURCES).registerReloadListener(new ResourceReloadListenerWrapper(MTTextures::getAtlasHolder, ResourceLocation.fromNamespaceAndPath(MineTogetherPartners.MOD_ID, "gui_atlas_reload")));
        }
    }
